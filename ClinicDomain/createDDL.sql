...
CREATE TABLE BILLINGRECORD (ID BIGINT NOT NULL, AMOUNT FLOAT, DATE DATE, DESCRIPTION VARCHAR(255), treatment_id BIGINT, PRIMARY KEY (ID))
...
ALTER TABLE BILLINGRECORD ADD CONSTRAINT FK_BILLINGRECORD_treatment_id FOREIGN KEY (treatment_id) REFERENCES TREATMENT (ID)
