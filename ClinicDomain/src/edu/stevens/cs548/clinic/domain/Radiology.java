...
public class Radiology extends Treatment implements Serializable {
	...
	public void visit(ITreatmentVisitor visitor){
		visitor.visitRadiology(this.getId(), this.getDiagnosis(), this.getDates(), this.getProvider(), this.getPatient());
	}

	public <T> T export(ITreatmentExporter<T> visitor){
		return visitor.exportRadiology(this.getId(), this.getDiagnosis(), this.getDates(), this.getProvider(),this.getPatient());
	}
