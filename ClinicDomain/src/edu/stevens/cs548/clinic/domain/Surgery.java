...
public class Surgery extends Treatment implements Serializable {
	...
	public void visit(ITreatmentVisitor visitor){
		visitor.visitSurgery(this.getId(), this.getDiagnosis(), this.getDate(), this.getProvider(),this.getPatient());
	}
	
	public <T> T export(ITreatmentExporter<T> visitor) {
		return visitor.exportSurgery(this.getId(), this.getDiagnosis(), this.getDate(), this.getProvider(), this.getPatient());
	}
