...
public class TreatmentType {
    ...
    protected DrugTreatmentType drugtreatment=new DrugTreatmentType();
    protected RadiologyType radiology=new RadiologyType();
    protected SurgeryType surgery=new SurgeryType();
